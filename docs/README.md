...
역할 1의 실제 API endpoint, metric 이름·단위, payload, Mock 및 실연결 결과는
[api_tools.md](api_tools.md)를 기준으로 확인한다. 원천 실응답 필드 분석은
[08_API_실응답_필드_분석.md](08_API_실응답_필드_분석.md)에 기록한다.
